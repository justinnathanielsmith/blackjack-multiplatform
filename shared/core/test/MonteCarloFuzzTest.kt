...
class MonteCarloFuzzTest {
    ...
    fun conservation_100k_games_noChipsLeaked() {
        ...
        repeat(iterations) { i ->
            ...
            if (totalChipsAfter != initialBalance.toLong()) {
                ...
                val dealerHand = engine.state.dealerHand.cards.joinToString { "${it.rank}" }
                val playerHands = engine.state.playerHands.joinToString(" | ") { hand ->
    ...
    fun strategy_ev_converges_to_theoretical() {
        ...
        assertTrue(actualRTP in lowerBound..upperBound, 
    ...
    fun conservation_withSideBets_noChipsLeaked() {
        ...
        repeat(iterations) {
            ...
            assertEquals(initialBalance.toLong(), balanceAfter + cumulativeDealerProfit, 
