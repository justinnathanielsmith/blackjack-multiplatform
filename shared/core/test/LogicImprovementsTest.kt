...
class LogicImprovementsTest {
    ...
    @Test
    fun placeBet_emitsVibrate_whenInsufficientBalance() = runTest {
        val sm = testMachine(
    ...
    @Test
    fun selectHandCount_emitsVibrate_whenInsufficientBalance() = runTest {
        val sm = testMachine(
    ...
    @Test
    fun selectHandCount_emitsVibrate_whenInvalidCount() = runTest {
        val sm = testMachine(
    ...
    @Test
    fun handleDeal_reshuffles_whenDeckIsEmpty() = runTest {
        val sm = testMachine(
            GameState(
