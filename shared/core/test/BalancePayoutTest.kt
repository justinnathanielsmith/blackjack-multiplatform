...
class BalancePayoutTest {
    ...
    @Test
    fun blackjackPayout_3to2() = runTest {
    ...
    @Test
    fun blackjackPayout_6to5() = runTest {
    ...
    @Test
    fun naturalBlackjack_3to2_multiHand() = runTest {
    ...
    @Test
    fun surrender_validOnFirstDecision() = runTest {
    ...
    @Test
    fun surrender_invalidAfterHit() = runTest {
        val sm = BlackjackStateMachine(
            this,
            GameState(
                status = GameStatus.PLAYING,
    ...
    @Test
    fun surrender_noOpWhenRuleDisabled() = runTest {
        val sm = BlackjackStateMachine(
            this,
            GameState(
                status = GameStatus.PLAYING,
    ...
    @Test
    fun multiHand_independentPayouts() = runTest {
    ...
    @Test
    fun multiHand_playerWonIfAnyHandWins() = runTest {
    ...
    @Test
    fun multiHand_dealerWonIfAllHandsLose() = runTest {
    ...
    @Test
    fun multiHand_pushIfAllHandsPush() = runTest {
