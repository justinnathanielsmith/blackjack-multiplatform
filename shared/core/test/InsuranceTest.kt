...
class InsuranceTest {
    ...
    @Test
    fun insurance_offered_when_dealer_ace() = runTest {
        ...
        assertEquals(Rank.ACE, sm.state.value.dealerHand.cards[0].rank)
        assertEquals(GameStatus.INSURANCE_OFFERED, sm.state.value.status)
    }

    @Test
    fun insurance_not_offered_when_dealer_non_ace() = runTest {
    ...
    @Test
    fun takeInsurance_deductsHalfBet() = runTest {
    ...
    @Test
    fun declineInsurance_noBalanceChange() = runTest {
        val sm = BlackjackStateMachine(
            this,
            GameState(
                status = GameStatus.INSURANCE_OFFERED,
    ...
    @Test
    fun insurance_paysOn_dealerBlackjack() = runTest {
    ...
    @Test
    fun insurance_forfeitedOn_noDealerBlackjack() = runTest {
    ...
    @Test
    fun insurance_invalidIn_wrongStatus() = runTest {
