...
class BettingPhaseTest {
    ...
    @Test
    fun placeBet_decreasesBalanceAndIncreasesCurrentBet() = runTest {
    ...
    @Test
    fun placeBet_multipleChipsAccumulate() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 1000, currentBet = 0))
    ...
    @Test
    fun placeBet_rejectedWhenAmountExceedsBalance() = runTest {
    ...
    @Test
    fun placeBet_rejectedWhenAmountZeroOrNegative() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 1000, currentBet = 0))
    ...
    @Test
    fun placeBet_ignoredWhenNotInBettingPhase() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.PLAYING, balance = 1000, currentBet = 100))
        sm.dispatch(GameAction.PlaceBet(50))
        advanceUntilIdle()
    ...
    @Test
    fun resetBet_restoresBalanceAndClearsCurrentBet() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 900, currentBet = 100))
    ...
    @Test
    fun resetBet_ignoredWhenNotInBettingPhase() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.PLAYING, balance = 900, currentBet = 100))
        sm.dispatch(GameAction.ResetBet)
        advanceUntilIdle()
    ...
    @Test
    fun selectHandCount_updatesHandCount() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 1000, currentBet = 0))
    ...
    @Test
    fun selectHandCount_ignoredOutsideBetting() = runTest {
        val initialState = GameState(
            status = GameStatus.PLAYING,
            balance = 900,
            currentBet = 100,
            playerHands = kotlinx.collections.immutable.persistentListOf(
    ...
    @Test
    fun selectHandCount_ignoresInvalidValues() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 1000, currentBet = 0))
    ...
    @Test
    fun selectHandCount_adjustsBalanceWhenBetPlaced() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 900, currentBet = 100, handCount = 1))
        sm.dispatch(GameAction.SelectHandCount(3))
        advanceUntilIdle()
    ...
    @Test
    fun selectHandCount_refundsBalanceWhenReducingHands() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 700, currentBet = 100, handCount = 3))
        sm.dispatch(GameAction.SelectHandCount(2))
        advanceUntilIdle()
    ...
    @Test
    fun selectHandCount_rejectedIfInsufficientBalance() = runTest {
    ...
    @Test
    fun selectHandCount_noBalanceChangeWhenNoBet() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 1000, currentBet = 0, handCount = 1))
        sm.dispatch(GameAction.SelectHandCount(3))
        advanceUntilIdle()
    ...
    @Test
    fun deal_createsTwoHandsWhenHandCount2() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 1000, currentBet = 100, handCount = 2))
    ...
    @Test
    fun deal_doesNotDeductBalanceForMultiHand() = runTest {
    ...
    @Test
    fun placeBet_rejectedWhenTotalCostExceedsBalance() = runTest {
    ...
    @Test
    fun placeBet_deductsTotalCostForAllHands() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 1000, currentBet = 0, handCount = 3))
    ...
    @Test
    fun resetBet_refundsTotalCost() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.BETTING, balance = 700, currentBet = 100, handCount = 3))
        sm.dispatch(GameAction.ResetBet)
        advanceUntilIdle()
    ...
    @Test
    fun newGame_resetsHandCountTo1() = runTest {
        val sm = BlackjackStateMachine(this, GameState(status = GameStatus.DEALER_WON, balance = 800, currentBet = 0, handCount = 3))
    ...
    @Test
    fun newGame_usesRulesDeckCount() = runTest {
    ...
    @Test
    fun newGame_defaultDeckCountIs6() = runTest {
        val sm = BlackjackStateMachine(this)
        sm.dispatch(GameAction.NewGame())
        advanceUntilIdle()
        sm.dispatch(GameAction.PlaceBet(100))
