...
This file tracks the progress of various development streams.

| Track ID | Title | Status | Link |
| :--- | :--- | :--- | :--- |
| `initial-setup` | Initial Documentation & Spec | ✅ Completed | - |
...
| `advanced-rules` | Doubling Down, Splitting & Insurance | 🚧 In Progress | [Link](./tracks/advanced-rules/index.md) |
| `ui-juice` | UI Polish & "Juicy" Animations | 📅 Backlog | - |
